...
public enum EndpointEnum {
  ...
  OSS_CN_QINGDAO_CLASSICAL("oss", "cn-qingdao", "classical",
      "oss-cn-qingdao-internal.aliyuncs.com"),
  OSS_CN_BEIJING_CLASSICAL("oss", "cn-beijing", "classical",
      "oss-cn-beijing-internal.aliyuncs.com"),
  OSS_CN_SHENZHEN_CLASSICAL("oss", "cn-shenzhen", "classical",
      "oss-cn-shenzhen-internal.aliyuncs.com"),
  OSS_CN_HONGKONG_CLASSICAL("oss", "cn-hongkong", "classical",
      "oss-cn-hongkong-internal.aliyuncs.com"),
  OSS_US_WEST_1_CLASSICAL("oss", "us-west-1", "classical",
      "oss-us-west-1-internal.aliyuncs.com"),
  OSS_US_EAST_1_CLASSICAL("oss", "us-east-1", "classical",
      "oss-us-east-1-internal.aliyuncs.com"),
  OSS_AP_SOUTHEAST_1_CLASSICAL("oss", "ap-southeast-1",
      "classical", "oss-ap-southeast-1-internal.aliyuncs.com"),

  OSS_CN_HANGZHOU_VPC("oss", "cn-hangzhou", "vpc",
      "vpc100-oss-cn-hangzhou.aliyuncs.com"),
  OSS_CN_SHANGHAI_VPC("oss", "cn-shanghai", "vpc",
      "vpc100-oss-cn-shanghai.aliyuncs.com"),
  OSS_CN_QINGDAO_VPC("oss", "cn-qingdao", "vpc",
      "vpc100-oss-cn-qingdao.aliyuncs.com"),
  OSS_CN_BEIJING_VPC("oss", "cn-beijing", "vpc",
      "vpc100-oss-cn-beijing.aliyuncs.com"),
  OSS_CN_SHENZHEN_VPC("oss", "cn-shenzhen", "vpc",
      "vpc100-oss-cn-shenzhen.aliyuncs.com"),
  OSS_US_WEST_1_VPC("oss", "us-west-1", "vpc",
      "vpc100-oss-us-west-1.aliyuncs.com"),
  OSS_US_EAST_1_VPC("oss", "us-east-1", "vpc",
      "oss-us-east-1-internal.aliyuncs.com"),
