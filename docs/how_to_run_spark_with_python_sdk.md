...
2. download the pre-build [**emr-maxcompute_2.11-1.6.0.jar**](http://central.maven.org/maven2/com/aliyun/emr/emr-maxcompute_2.11/1.6.0/emr-maxcompute_2.11-1.6.0.jar);
