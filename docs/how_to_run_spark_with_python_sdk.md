...
emr-logservice_2.11-1.4.0-SNAPSHOT.jar,loghub-client-lib-0.6.4.jar,aliyun-log-0.6.2.jar  
...
5. run the example, use
```
   spark-submit --master local[4] --jars aspectjrt-1.8.2.jar,emr-maxcompute_2.11-1.4.0-SNAPSHOT.jar,
