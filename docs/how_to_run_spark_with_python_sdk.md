...
2. download the pre-build [**emr-logservice_2.11-1.6.1-SNAPSHOT.jar**](http://central.maven.org/maven2/com/aliyun/emr/emr-logservice_2.11/1.6.1-SNAPSHOT/emr-logservice_2.11-1.6.1-SNAPSHOT.jar);
...
emr-logservice_2.11-1.6.1-SNAPSHOT.jar,loghub-client-lib-0.6.13.jar,aliyun-log-0.6.11.jar,json-lib-2.4-jdk15.jar
...
2. download the pre-build [**emr-maxcompute_2.11-1.6.1-SNAPSHOT.jar**](http://central.maven.org/maven2/com/aliyun/emr/emr-maxcompute_2.11/1.6.1-SNAPSHOT/emr-maxcompute_2.10-1.6.1-SNAPSHOT.jar);
...
5. run the example, use
```
   spark-submit --master local[4] --jars fastjson-1.2.23.jar,aspectjrt-1.8.2.jar,emr-maxcompute_2.11-1.6.1-SNAPSHOT.jar,
