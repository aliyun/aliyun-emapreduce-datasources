...
2. download the pre-build [**emr-logservice_2.11-1.4.1jar**](http://central.maven.org/maven2/com/aliyun/emr/emr-logservice_2.11/1.4.1/emr-logservice_2.11-1.4.1.jar);
...
2. download the pre-build [**emr-maxcompute_2.11-1.4.1jar**](http://central.maven.org/maven2/com/aliyun/emr/emr-maxcompute_2.11/1.4.1/emr-maxcompute_2.10-1.4.1.jar);
