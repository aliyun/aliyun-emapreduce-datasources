...
-- create temporary function ots_col_parser as 'org.apache.spark.sql.aliyun.udfs.tablestore.ResolveTableStoreBinlogUDF' using jar '/root/emr-sql_2.11-2.1.0-SNAPSHOT.jar';
