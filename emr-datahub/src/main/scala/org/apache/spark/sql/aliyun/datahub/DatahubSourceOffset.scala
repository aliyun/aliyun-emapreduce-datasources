...
// scalastyle:off
case class DatahubSourceOffset(shardToOffsets: Map[DatahubShard, Long]) extends Offset {
...
object DatahubSourceOffset {
  ...
  def getShardOffsets(offset: ReadStreamingOffset): Map[DatahubShard, Long] = {
    offset match {
