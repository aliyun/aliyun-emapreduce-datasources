...
DROP TABLE IF EXISTS kafka_temp_table_q101;

SET spark.testing=${TESTING_ENABLE};
SET spark.sql.streaming.query.timeout.ms=${TESTING_TIMEOUT_MS};
SET streaming.query.name=job101;
SET spark.sql.streaming.checkpointLocation.job101=${CHECKPOINT_ROOT}/job101;

CREATE TABLE kafka_temp_table_q101
USING kafka
OPTIONS (
kafka.bootstrap.servers = "${BOOTSTRAP_SERVERS}",
subscribe = 'temp_topic_q101',
...
INSERT INTO kafka_temp_table_q101
SELECT
  i_brand_id brand_id,
  i_brand brand,
