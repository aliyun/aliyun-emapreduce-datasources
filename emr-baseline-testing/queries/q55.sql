...
DROP TABLE IF EXISTS kafka_temp_table_q55;

SET spark.testing=${TESTING_ENABLE};
SET spark.sql.streaming.query.timeout.ms=${TESTING_TIMEOUT_MS};
SET streaming.query.name=job55;
SET spark.sql.streaming.checkpointLocation.job55=${CHECKPOINT_ROOT}/job55;

CREATE TABLE kafka_temp_table_q55
USING kafka
OPTIONS (
kafka.bootstrap.servers = "${BOOTSTRAP_SERVERS}",
subscribe = 'temp_topic_q55',
...
INSERT INTO kafka_temp_table_q55
SELECT
  i_brand_id brand_id,
  i_brand brand,
