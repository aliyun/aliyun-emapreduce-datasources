...
public class TableStoreInputSplit extends FileSplit implements InputSplit, Writable {
    ...
    private org.apache.spark.aliyun.tablestore.hadoop.TableStoreInputSplit delegated;
    ...
    public TableStoreInputSplit(
        org.apache.spark.aliyun.tablestore.hadoop.TableStoreInputSplit delegated,
        Path path) {
        super(path, 0, 0, (String[]) null);
        this.delegated = delegated;
    }

    public org.apache.spark.aliyun.tablestore.hadoop.TableStoreInputSplit getDelegated() {
    ...
    @Override public void readFields(DataInput in) throws IOException {
        super.readFields(in);
        this.delegated =
          org.apache.spark.aliyun.tablestore.hadoop.TableStoreInputSplit.read(in);
    }
}
