...
public class TableStoreInputFormat implements InputFormat<PrimaryKeyWritable, RowWritable> {
    ...
    private static Configuration translateConfig(Configuration from) {
        ...
        {
            org.apache.spark.aliyun.tablestore.hadoop.Credential cred =
              new org.apache.spark.aliyun.tablestore.hadoop.Credential(
        ...
        }
        {
            ...
            org.apache.spark.aliyun.tablestore.hadoop.Endpoint ep;
            if (instance == null) {
                ep = new org.apache.spark.aliyun.tablestore.hadoop.Endpoint(
                  endpoint);
            } else {
                ep = new org.apache.spark.aliyun.tablestore.hadoop.Endpoint(
                  endpoint, instance);
    ...
    @Override public RecordReader<PrimaryKeyWritable, RowWritable> getRecordReader(
      InputSplit split, JobConf job, Reporter reporter) throws IOException {
        ...
        final org.apache.spark.aliyun.tablestore.hadoop.TableStoreRecordReader rdr =
          new org.apache.spark.aliyun.tablestore.hadoop.TableStoreRecordReader();
